...
\begin{itemize}
\item[\textbullet] You should submit Homework 2 before 5/31 (including 5/31).
...
\item[\textbullet] Upload files here: \textbf{\url{https://www.dropbox.com/request/c3m4qdykIQ89IwmPRxdJ}}
...
\subsection*{Question 6 \quad Preliminary Results}
Create a table or figure to present your findings, and write paragraphs explaining them. Specify this as Figure 1 (or Table 2) in your answer sheet. Include:
\begin{itemize}
  \item A description of what you see in the table or figure (e.g., the sign, magnitude, and statistical significance of your main estimates).
  \item An interpretation of what these results mean in the context of your research question.
\end{itemize}
...
\subsection*{Question 7 \quad AI Assistance}
If you used generative AI (e.g., ChatGPT, Claude) to assist your research, describe how you used it. Include:
\begin{itemize}
  \item What kind of tasks generative AI helped you complete; provide a specific example.
  \item The prompts you gave to the AI.
\end{itemize}
If you did \textbf{not} use generative AI, describe either (a) a concern you have about using AI in research, or (b) a specific type of task where you find AI unreliable or untrustworthy—and explain why.
