...
\begin{frame}{Demeaning Approach}{}
	\begin{itemize}
		...
		\vspace{0.2cm}
		\item \textbf{Intuition}: identification comes entirely from \textbf{within-unit variation} — how a worker's union status and earnings change \textit{over time}, not from comparing different workers cross-sectionally
		\vspace{0.2cm}
		\begin{itemize}
