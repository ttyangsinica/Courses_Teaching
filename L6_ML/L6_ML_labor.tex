...
\end{frame}
	...
	% 		\vspace{0.2cm}
	% 		\begin{itemize}
	% 			\item \textbf{Part I (Previous Lecture):} Regression --- the foundational ML tool for causal inference under selection on observables
	% 			\vspace{0.2cm}
	% 			\item \textbf{Part II (This Lecture):} Post-Double Selection --- handling high-dimensional covariates with LASSO
	% 			\vspace{0.2cm}
	% 			\item \textbf{Part III (Next Lecture):} Heterogeneous Treatment Effects --- estimating CATE with Causal Forest
	% 		\end{itemize}
	% 	\end{itemize}
	% \end{frame}
	...
	\begin{frame}{From Regression to High-Dimensional Settings}
		\begin{itemize}
			\item \textbf{Recall from Part I:} Under the Conditional Independence Assumption (CIA), regression controls for observed confounders $X$ to identify the causal effect of treatment $D$
			\begin{eqnarray*}
...
\begin{frame}{LASSO regression}
	\begin{itemize}	
		...
		\begin{itemize}
			...
			%\item Best when many predictors important with coeffs of similar size
			%\vspace{0.2cm}
