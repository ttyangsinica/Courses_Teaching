...
\begin{frame}[fragile]{Heterogeneous Treatment Effects}{Setup}
...
\begin{frame}[fragile]{Heterogeneous Treatment Effects}{Output}
...
\begin{frame}{How to Share Your Results}{Stata Markdown}
...
\begin{frame}[fragile]{Installation}{One-Time Setup}
...
\begin{frame}[fragile]{Compiling a \texttt{.stmd} File}
...
\begin{frame}[fragile]{Stata Markdown File Structure (1)}
...
\begin{frame}[fragile]{\texttt{.stmd} File Structure (2)}
...
\end{lstlisting}
	...
	\begin{itemize}
		...
		\vspace{0.1cm}
		\item Full file \texttt{regression.stmd} is available on the course dropbox
	\end{itemize}
...
\begin{frame}[fragile]{Key Syntax Elements}
...
\begin{frame}{How to Share Your Results}{R Markdown}
...
\begin{frame}[fragile]{Installation and Compile}
...
\begin{frame}[fragile]{R Markdown File Structure (1)}
...
\begin{frame}[fragile]{R Markdown File Structure (2)}
...
\begin{frame}[fragile]{R Markdown Key Syntax Elements}
	...
	\begin{itemize}
		...
		\vspace{0.2cm}
		\item Full file \texttt{regression.Rmd} is available on the course dropbox
	\end{itemize}
