...
% 	Ameet Morjaria, and Gerard Padró i Miquel (2015), ``\textbf{The Value of Democracy: 
...
\begin{frame}{Satellite Images}{Other Satellite Data Sources}
\begin{itemize}
    \item \textbf{Vegetation Index (NDVI)}
    \begin{itemize}
        \vspace{0.1cm}
        \item Proxy for agricultural productivity and rainfall
        \item Resolution: 250m--1km, 16-day or monthly composites
        \item Source (NASA MODIS): 
        \href{https://modis.gsfc.nasa.gov/data/dataprod/mod13.php}{modis.gsfc.nasa.gov}
    \end{itemize}
    \vspace{0.2cm}
    \item \textbf{Land Surface Temperature (LST)}
    \begin{itemize}
        \vspace{0.1cm}
        \item Measure heat islands and climate exposure
        \item Resolution: 1km, daily or 8-day composites
        \item Source (NASA MODIS MOD11): 
        \href{https://modis.gsfc.nasa.gov/data/dataprod/}{modis.gsfc.nasa.gov}
    \end{itemize}
    \vspace{0.2cm}
    \item \textbf{Aerosol Optical Depth (AOD)}
    \begin{itemize}
        \vspace{0.1cm}
        \item Proxy for PM2.5 and pollution exposure
        \item Resolution: 3km--10km, daily
        \item Source (NASA MODIS MOD04): 
        \href{https://modis.gsfc.nasa.gov/data/dataprod/}{modis.gsfc.nasa.gov}
    \end{itemize}
    \vspace{0.15cm}
    \item All products freely available at 
...
\begin{frame}{Vector Data}{Points}
	...
	\begin{minipage}{0.3\linewidth}
		\begin{figure}[H]
			\scalebox{1}{\includegraphics{figure/stata_spatial-1.jpg}}
		\end{figure}
	\end{minipage}
\end{frame}
...
\begin{frame}{Vector Data}{Polygons}
	...
	\begin{minipage}{0.3\linewidth}
		\begin{figure}[H]
			\scalebox{1}{\includegraphics{figure/stata_spatial-2.jpg}}
			%\scalebox{1}{\includegraphics[width=.8\textwidth]{figure/TWN_2013.png}}
		\end{figure}
	\end{minipage}
\end{frame}
...
\begin{frame}{Raster Data}{Spatial Fields}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\vspace{0.2cm}
			\item A raster cell/pixel value should normally represeent the average (or majority) value for the area it covers
		\end{itemize}
...
\begin{frame}{Raster Data}{Night Light from Satellite Images}
	\begin{minipage}{0.6\linewidth}
		\begin{itemize}
			\item Each raster pixel value in a satellite image is from 0 to 63
			\vspace{0.2cm}
			\item It represent the light intensity at night in Taiwan
	...
	\begin{minipage}{0.3\linewidth}
		\begin{figure}[H]
			%\scalebox{1}{\includegraphics{stata_spatial-2.jpg}}
			\scalebox{1.5}{\includegraphics[width=1.0\textwidth]{figure/TWN_2013.png}}
		\end{figure}
	\end{minipage}
\end{frame}
...
\begin{frame}{Coordinate Systems}
	\begin{itemize}
		...
		\vspace{0.2cm}
		\item To view and manipulate your data, these identiﬁers will need to be referenced to a \textbf{coordinate system}
		\vspace{0.2cm}
...
\begin{frame}{Geographic Coordinate Systems}
	\begin{itemize}
		...
		\vspace{0.2cm}
		\begin{itemize}
			\item We also use \textbf{TWD67} or \textbf{TWD97}
		\end{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\vspace{0.2cm}
	\item All projections introduce some distortions, and different projections minimize distortions along different dimensions
...
1 北投區    6301200042 湖田里10鄰 (((304697.5 2786869, 304692.4 278…
2 士林區    6301100047 菁山里10鄰 (((307802.2 2787373, 307831.9 278…
3 北投區    6301200042 湖田里9鄰  (((303166.5 2786151, 303171.5 278…
\end{lstlisting}
...
<chr>     <int>                                <POLYGON [m]>
1 中山區      877 ((303114 2771127, 303073.9 2771140, 303052.…
2 中正區      582 ((302426.9 2768031, 302382.4 2768063, 30237…
3 信義區      922 ((307636.1 2767150, 307636.2 2767129, 30763…
\end{lstlisting}
...
1 6300100002    171924. ((306971 2773055), (306978 2773026), …
2 6300100003    246851. ((306087 2772446), (306129 2772370), …
3 6300100004    209986. ((306657 2772613), (306664 2772667), …
\end{lstlisting}
