...
\begin{center}
  ...
  \begin{tabular}{@{}llc@{}}
    ...
    Tree B & Educ $< 11$ $\to$ \textbf{No} & \$30/hr \\
    \bottomrule
  \end{tabular}
\end{center}
...
\begin{center}
\begin{tikzpicture}[
  level 1/.style={sibling distance=3.3cm, level distance=1.9cm},
  internal/.style={draw, rounded corners, fill=orange!25,
...
\vspace{0.25cm}
\begin{itemize}
  \item Each \textbf{leaf} = a subgroup of workers\\with similar covariates $x$
  \vspace{0.15cm}
  \item Within each leaf, estimate CATE by\\comparing treated vs.\ control means
  \vspace{0.15cm}
  ...
  \]
  \vspace{0.05cm}
  \item Workers with similar $x$ share the\\same estimated treatment effect
\end{itemize}
\end{column}
