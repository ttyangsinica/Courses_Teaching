...
&= \underbrace{\mathrm{E}[\mathrm{Y}^{1}_{i}-\mathrm{Y}^{0}_{i}|p(X_{i}),D_i=0]}_{\text{CATU}}
...
\begin{frame}{Identification Results for PSM}{ATT}
	\begin{itemize}
...
\begin{frame}{Identification Results for PSM}{ATU}
	\begin{itemize}
...
\begin{frame}{Identification Results for PSM}{ATE}
	\begin{itemize}
