...
\begin{frame}{Deriving the Shift-Share IV} 
	\begin{itemize}
		...
		\begin{itemize}
			...
			\vspace{0.2cm}
			\item $\Delta R_{ikt}$ is the change in endogenous variable for industry $k$ in region $i$ 
			\vspace{0.2cm}
...
%\end{frame}
	...
	\begin{itemize}
		...
		\item Boustan, Leah, Fernando V Ferreira, Hernan Winkler, and Eric M Zolt. 2013. \textit{``The Effect of Rising Income Inequality on Taxation and Public Expenditures: Evidence from U.S. Municipalities and School Districts, 1970-2000."} The Review of Economics and Statistics, 95(1291).
