...
\begin{frame}{From Regression to High-Dimensional Settings}
	...
	\begin{frame}{Problem of High-Dimensional Data}{Example 1: Test the Convergence Hypothesis}
	...
	\begin{frame}{Problem of High-Dimensional Data}{Example 2: Effect of Abortion on Crime}
...
\begin{frame}{Cross-validation approach}{Training Data}
    \begin{itemize}
        ...
        \end{eqnarray*}
        \vspace{0.1cm}
        \item For each value of the tuning parameter $\lambda \in \{\lambda_{1},\ldots,\lambda_{m} \}$, choose $(\hat{\beta}_{1}, \hat{\beta}_{2}, \ldots, \hat{\beta}_{p})$ 
