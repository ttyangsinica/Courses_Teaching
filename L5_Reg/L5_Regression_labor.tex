...
\end{lstlisting}
	...
	\begin{itemize}
		...
		\vspace{0.2cm}
		\item The full file \texttt{regression.Rmd} is available on the course website
	\end{itemize}
...
\end{lstlisting}
	...
	\begin{itemize}
		\item The inline expression \texttt{{\char96} r round(coef(model3)["college"], 0){\char96}} inserts the estimated coefficient directly into the sentence --- updates automatically when data or model changes
	\end{itemize}
...
\begin{frame}[fragile]{Reproducible Research: Key Syntax Elements}
	...
	\begin{itemize}
		\item \texttt{echo=FALSE}: hides code, shows output; \texttt{include=FALSE}: hides both
		\vspace{0.2cm}
