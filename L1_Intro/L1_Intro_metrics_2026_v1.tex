...
\begin{frame}{About Me}
	\begin{itemize} 
		...
		\item Other Appointments: 
					\begin{itemize}
											\vspace{0.3cm}			
			\item  NTU-AGEC, NTU-ECON and NCCU-IMES	 
					\vspace{0.3cm}			
		\item Office at NTU:  農業綜合館218-B5
		...
		\vspace{0.3cm}
		\item Email: \url{ttyang@g.ntu.edu.tw}
					%\begin{itemize}
		%\vspace{0.3cm}
...
\begin{frame}{This Course}
	\begin{itemize} 
		...
		\item This course is a \textbf{required course for doctoral students} in the Department of Agricultural Economics.
        	\vspace{0.2cm}
		\begin{itemize} 
        \item It is also suitable for \textbf{master's students} who wish to pursue empirical research in economics and related fields.
        		\vspace{0.2cm}
...
\begin{frame}{This Course}
	\begin{itemize} 
		...
		\item The goal of this course is to equip students with a comprehensive set of statistical tools that are useful in conducting high-quality empirical research in applied microeconomics
		\vspace{0.2cm}
		\item Specifically, the course places a strong emphasis on \textbf{causal inference/machine learning} and understanding their applications
		\vspace{0.2cm}
		...
		\begin{itemize} 
			...
			\vspace{0.2cm}
			\item Provide a good start for your PhD/Master thesis
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}{Empirical research in Economics}
...
\begin{frame}{2021 Nobel Laureates}{Labor Economics and Causal Inference}
...
\begin{frame}{Empirical research in Economics}
	...
	\begin{itemize} 
		...
		\vspace{0.2cm} 
		\begin{itemize} 
			\item A movement that emphasizes how our increasing ability to collect and analyze vast amounts of data can transform our understanding of the human behaviors
			
			
			%A movement that emphasizes how our increasing ability to produce, collect, store, and analyze vast amounts of data is going to transform our understanding of the human behaviors
		\end{itemize}
				\vspace{0.2cm} 
	\item Recent trend in empirical research 
		\vspace{0.2cm} 
	\begin{itemize} 
		\item Use large scale dataset to identify causal relationship
\vspace{0.2cm}
...
% 		\vspace{0.2cm}
% 		\begin{itemize} 
% 			\item Focus on \textbf{causal inference} and its applications in labor economics 
% 			%\vspace{0.2cm}
% 			%\item How to conduct an empirical research
% 		\end{itemize}
% 	\end{itemize}
...
\begin{frame}{Causal Inference}{Example 1}
	\begin{itemize} 
		...
		\item The effect of \color{blue}{attending cram school} \color{black}{on} \color{red}{exam scores}
		\vspace{0.2cm}
		\begin{itemize}
			\item Ideally, we should get the causal effect by comparing the exam scores of \textbf{the same students} with and without attending cram school
			\vspace{0.2cm}
			\item For each particular student, we can observe \textbf{only one outcome with specific treatment at the same time}: 
			\vspace{0.2cm}
			\begin{itemize}
				\item Attending cram school
				\vspace{0.2cm}
				\item Not attending cram school
			\end{itemize}
...
\begin{frame}{Causal Inference}{Example 1}
	\begin{itemize} 
		...
		\begin{itemize}
			...
			\vspace{0.2cm}
			\begin{itemize}
				\item Exam scores of those attending cram school
				\vspace{0.2cm}
				\item Exam scores of those not attending cram school
				\vspace{0.2cm}
			\end{itemize}
			\item Simply comparing those who are and are not treated may provide a misleading estimate of a causal effect    
			\vspace{0.2cm}
			\item There must be a reason why some students choose to attend cram school and some do not  
			\vspace{0.2cm}
			\begin{itemize}
				\item For example, students who attend cram school may come from wealthier families or be more motivated to study
				\vspace{0.2cm}
				\item Two groups of students might not be comparable
			\end{itemize}
			\vspace{0.2cm}
			\item We need to isolate the causal effect from the effect of other confounding factors
		\end{itemize}
...
\begin{frame}{Gold Standard}{Randomized Experiment}
	\begin{itemize} 
		
		%\item In this course, we will introduce at least 7 methods of causal inference: 
		%\vspace{0.3cm}
		\item[0] Randomized Experiment (RCT)
		\vspace{0.3cm}
		\begin{itemize} 	
			\item Randomly assign treatment ensures that every observation has the same probability of being assigned to the treatment group
			\vspace{0.3cm}	
			\item The characteristics of treatment and comparison groups are similar  since receiving treatment is unrelated to any other confounding factors
			\vspace{0.3cm}	
			\item Then, we can obtain causal effect of treatment by simply comparing outcomes between treatment and comparison groups
		\end{itemize}	
...
\item RCT is the gold standard of causal inference
\vspace{0.2cm}

        \item However, it has some limitations
\vspace{0.2cm}
...
\begin{frame}{Control-based Methods}{Matching Methods}
	\begin{itemize} 
		\item[2] Matching Methods
		\vspace{0.3cm}
		\begin{itemize} 		
			\item Assume key differences between treatment and comparison groups are \textbf{observable}
			\vspace{0.3cm}
			\item Construct a comparison group that have similar \textbf{observable} characteristics as treatment group
			%\vspace{0.3cm}
			%\item Use machine learning method to decide which observable characteristics should be included in the regression
...
\begin{frame}{Control-based Methods}{Regression and Causal Machine Learning}
	\begin{itemize} 
		\item[3] Regression and Causal Machine Learning
		\vspace{0.3cm}
		\begin{itemize} 		
			
			\item Use regression to control for observable confounding factors 
								\vspace{0.3cm}
			\item Use machine learning method to decide which observable characteristics is important so that we should include in regression
					\vspace{0.3cm}
							\begin{itemize} 		
			\item Post-Double selection method		
					\end{itemize}
		\end{itemize}
...
\begin{frame}{Control-based Methods}{Fixed Effect Regression}
	\begin{itemize} 
...
\begin{frame}{Design-based Methods}{Differences-in-Differences Design}
	\begin{itemize} 
		
		\item[5] Differences-in-Differences Design (DID)
		\vspace{0.3cm}
		\begin{itemize} 		
			\item If treatment and comparison group's outcomes move in parallel in the absence of treatment
			\vspace{0.3cm}
			\item Then we can use the trend in the outcome of the comparison group to represent the counterfactual trend for the treatment group
			
			
			
			%diverged trend in outcome of treatment group to represent causal effect of treatment
			%\item We can use the divergence of post-treatment path from the trend established by a control group to estimate a causal effect of the treatment
		\end{itemize}				
...
\begin{frame}{Design-based Methods}{Synthetic Control Method}
	\begin{itemize} 
		
		\item[6] Synthetic Control Method (SCM)
		\vspace{0.3cm}
		\begin{itemize} 		
			\item In some situations, treatment and comparison group's outcomes do not move parallelly before a treatment happens
			\vspace{0.3cm}
			\item Use \textbf{data-driven procedure} and \textbf{a small number of non-treated units}  to build a suitable counterfactual outcome	
...
\begin{frame}{Design-based Methods}{Regression Discontinuity Design}
	\begin{itemize} 
		
		
		\item[7] Regression Discontinuity Design (RDD)
		\vspace{0.3cm}
		\begin{itemize} 		
			\item When a treatment is applied depending on some thresholds
			\vspace{0.3cm}
					\begin{itemize} 		
			\item Assume the choices of thresholds are arbitrary
			\vspace{0.3cm}
					\end{itemize}	
			\item We can estimate causal effects by comparing
			outcomes for those just above threshold and those just below threshold 
							\vspace{0.3cm}
				\begin{itemize} 		
				\item Two groups should be similar since they are around threshold 
				\vspace{0.3cm}
			\end{itemize}	
		\end{itemize}	
...
\begin{frame}{Design-based Methods}{Instrumental Variables Design}
	\begin{itemize}
		
		
		\item[8] Instrumental Variables Design
		\vspace{0.3cm}
		\begin{itemize}
			\item The instrumental variable (IV) is: 
						\vspace{0.3cm}
								\begin{itemize}
			\item An exogenous source of variation that drives the treatment 
			\vspace{0.3cm}
			\item But it is unrelated to other confounding factors that affect outcome
			\vspace{0.3cm}
						\end{itemize}
			\item Intuitively, IV breaks variation of the treatment into two parts
			\vspace{0.3cm}
			\begin{itemize}
				\item[1] A part that might be correlated with other confounding factors
				\vspace{0.3cm}
				\item[2] A part that is not	(driven by IV)
			\end{itemize}
			\vspace{0.3cm}
			\item We can use the variation in treatment that is driven by IV to estimate causal effect of the treatment 
			
			
			%that is not correlated with other confounding factors to estimate causal effect of the treatment 
...
% \begin{frame}{Course Content: Model-Based Methods}{}
% \begin{itemize}
...
\vspace{0.2cm}
\item Collecting/Constructing your own dataset
\vspace{0.2cm}
...
\begin{itemize}
\item Generative AI as a coding assistant
\vspace{0.2cm}
\begin{itemize}
\item Writing and debugging code on demand
\vspace{0.2cm}
\item Translating data tasks described in plain language into working scripts
\vspace{0.2cm}
\item Accelerating iteration when exploring data or testing specifications
\end{itemize}
\vspace{0.2cm}
\item AI agents for semi-autonomous data workflows
\vspace{0.2cm}
\begin{itemize}
\item Executing multi-step, repetitive operations across files or datasets
\vspace{0.2cm}
\item Parsing and restructuring unstructured or irregularly formatted raw data
\end{itemize}
\end{itemize}
\end{frame}
...
\begin{frame}{Course Goals}
	\begin{itemize} 
		...
		\end{itemize}
		\vspace{0.3cm}
		\item Have a good start of your thesis
		
		%\item The goal of this class is for you to get a solid understanding of regression methods, of causality, and of (quasi-)experimental methods to estimate causal eects. The class should enable you to be a critical reader of empirical research, and to begin doing your own research.
...
\begin{frame}{Oral Exams}{4/22 week and 5/27 Week}
\begin{itemize}
...
\begin{frame}{Reading group presentation}{5/27 and 6/3}
	\begin{itemize} 
...
\begin{itemize} 
\item PhD students can be in a group of \textbf{2-3} persons
        	\end{itemize}
...
\begin{frame}{Term paper presentation}{6/10}
	\begin{itemize} 
...
\begin{frame}{Term paper deadline}{6/17}
	\begin{itemize}
...
\begin{frame}{Guideline for Writing a Term Paper}
	\begin{itemize} 
		...
		%\vspace{0.3cm}
		\item For PhD students, you may use your ongoing research as a term paper
		\vspace{0.2cm}
		\begin{itemize} 
			\item The paper must employ causal inference methods covered in (or related to) this course
			\vspace{0.2cm}
			\item However, the bar for completeness will be set higher
			\vspace{0.2cm}
			\item Feel free to discuss with me if you have any questions about this
