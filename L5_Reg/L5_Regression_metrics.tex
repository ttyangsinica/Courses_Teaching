...
\begin{frame}[fragile]{Reproducible Research: Compiling a \texttt{.stmd} File}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\vspace{0.1cm}
			\item The full file \texttt{regression.stmd} is available on the course website
		\end{itemize}
		\vspace{0.3cm}
...
\end{lstlisting}
	...
	\begin{itemize}
		\item \texttt{bundle} packs everything (CSS, images) into a single \texttt{.html} file --- easy to share
	\end{itemize}
