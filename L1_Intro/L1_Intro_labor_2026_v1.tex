...
\begin{frame}{About Me}
	\begin{itemize} 
		...
		\item Other Appointments: 
					\begin{itemize}
											\vspace{0.3cm}			
			\item NTU-ECON, NTU-AGEC and NCCU-IMES	 
					\vspace{0.3cm}			
		\item Office at NTU:  社科院724 / 農業綜合館218-B5
...
\begin{frame}{This Course}
	...
	\begin{itemize} 
		...
		\item The goal of this course is equip students with a comprehensive set of statistical tools that are useful in conducting high-quality empirical research in (labor) economics
		\vspace{0.2cm}
		...
		\begin{itemize} 
			...
			\vspace{0.2cm}
			\item Provide a good start for your thesis or writing sample
		\end{itemize}
	\end{itemize}
\end{frame}
...
\title[]  
{Labor Economics and Empirical Methods}
...
\begin{frame}{Labor Economics and Empirical Methods}
	%\begin{frame}{Economics, Causal Inference and Data Science}
	\begin{itemize} 
...
\begin{frame}{Design-based Methods}{Differences-in-Differences Design}
	\begin{itemize} 
		...
		\item[4] Differences-in-Differences Design (DID)
		\vspace{0.3cm}
		\begin{itemize} 		
...
\begin{frame}{Design-based Methods}{Instrumental Variables Design}
	\begin{itemize}
		...
		\item[7] Instrumental Variables Design
		\vspace{0.3cm}
		\begin{itemize}
...
\item[2] Discuss the applications in labor economics
\vspace{0.3cm}
...
\begin{frame}{Applications in Labor Economics}
	\begin{itemize} 
...
\begin{itemize} 
\item You should start early; the paper is due on 6/17
\vspace{0.3cm}
