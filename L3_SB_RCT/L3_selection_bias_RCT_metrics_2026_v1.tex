	...
	\begin{center}
		\begin{threeparttable}
			...
			\begin{tabular}{cccccc}
				...
				\midrule
				\textcolor{red}{David} & 1 & \tikzmark{atl}3\tikzmark{atr} & \tikzmark{btl}?\tikzmark{btr} & 3 & ? \\
				\textcolor{red}{Tina}  & 1 & \tikzmark{abl}2\tikzmark{abr} & \tikzmark{bbl}?\tikzmark{bbr} & 2 & ? \\
				Mary  & 0 & ? & 1 & 1 & ? \\
				Bill  & 0 & ? & 1 & 1 & ? \\
				\midrule
				$\mathrm{E}[\mathrm{Y}^{1}_{i}|D_i=1]$ & & 2.5 & & & \\
				$\mathrm{E}[\mathrm{Y}^{0}_{i}|D_i=1]$ & & & ? & & \\
				\bottomrule
			\end{tabular}
			\begin{tikzpicture}[remember picture, overlay]
				...
				\draw[thick, rounded corners=2pt]
					([xshift=-6pt, yshift=8pt]pic cs:btl) rectangle
					([xshift=6pt,  yshift=-3pt]pic cs:bbr);
			\end{tikzpicture}
		\end{threeparttable}
	\end{center}
	\vspace{0.2cm}
